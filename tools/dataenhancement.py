...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_img_path', type=str, default='data_uniform/images/PL')
    parser.add_argument('--source_xml_path', type=str, default='data_uniform/labels_xml/PL')
    parser.add_argument('--save_img_path', type=str, default='./data_enhance/images/PL')
    parser.add_argument('--save_xml_path', type=str, default='./data_enhance/labels_xml/PL')
